      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span
              className="mb-6 inline-flex items-center gap-2 px-4 
                py-2 text-sm font-medium text-orange-500 bg-orange-500/10 
              ...
              <div className="group bg-[#161616] rounded-2xl p-6 text-center border border-[#262626] hover:border-orange-500/30 transition-all duration-300">
                <div className="relative inline-block mb-4">
                  ...
                  <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-orange-500 rounded-full border-2 border-[#161616] flex items-center justify-center">
                    <i className="fas fa-check w-3 h-3 text-white"></i>
                  </div>
                </div>
                <h3 className="font-bold text-white text-lg">{writer.author.name}</h3>
                ...
                <div className="flex justify-center gap-3">
                  <Link
                    to="#"
                    className="w-9 h-9 bg-[#262626] rounded-lg flex items-center
                 justify-center text-neutral-500 hover:bg-orange-500
                 ...
                 justify-center text-neutral-500 hover:bg-orange-500
                  hover:text-white transition-colors"
                  >
                    <i className="w-4 h-4 fab fa-github"></i>
                  </Link>
                  <Link
                    to="#"
                    className="w-9 h-9 bg-[#262626] rounded-lg flex items-center
                 justify-center text-neutral-500 hover:bg-orange-500
                  hover:text-white transition-colors"
                  >
                    <i className="w-4 h-4 fab fa-linkedin"></i>
                  </Link>
                </div>
              </div>
            ))}
